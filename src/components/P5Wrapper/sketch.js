...
export default function(p) {
  ...
  // preload() -----------------------------------------------------------------
  p.preload = function() {
    source_1 = p.loadImage(image1);
    source_2 = p.loadImage(image2);
    source_3 = p.loadImage(image3);
    source_4 = p.loadImage(image4);
  };
  ...
  p.windowResized = () => {
    ...
    if (letter_1 && letter_2 && letter_3 && letter_4) {
  ...
  p.draw = function() {
    ...
    letter_1.display(globalX, globalY);
    letter_2.display(globalX, globalY);
    letter_3.display(globalX, globalY);
    letter_4.display(globalX, globalY);
